...
<head>
<title>Häufig gestellte Fragen &bull; Klammsbrücker Herold</title>
...
<div id="content3">
	...
	<tr>
		...
		<td class="gensmall" align="right">Aktuelle Zeit: Donnerstag, 30. März 2017, 16:25:52<br /></td>
	</tr>
	</table>
...
<div id="pagecontent">
	...
	<tr>
		<td class="row1">
			...
			<span class="gen"><b>Registrierung und Anmeldung</b></span><br />
				...
				<span class="gen"><a class="postlink" href="faq.php#f0r0">Warum kann ich mich nicht anmelden?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f0r1">Wozu muss ich mich überhaupt registrieren?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f0r2">Warum werde ich automatisch abgemeldet?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f0r3">Wie kann ich verhindern, dass mein Benutzername in der Online-Liste auftaucht?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f0r4">Ich habe mein Passwort vergessen!</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f0r5">Ich habe mich registriert, kann mich aber nicht anmelden!</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f0r6">Ich habe mich vor einiger Zeit registriert, kann mich aber nicht mehr anmelden?!</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f0r7">Was ist COPPA?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f0r8">Warum kann ich mich nicht registrieren?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f0r9">Wozu ist die „Alle Cookies des Boards löschen“-Funktion?</a></span><br />
			
			<br />
		
			<span class="gen"><b>Benutzerpräferenzen und -einstellungen</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f1r0">Wie kann ich meine Einstellungen ändern?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f1r1">Die Forenuhr geht falsch!</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f1r2">Ich habe die Zeitzone eingestellt, aber die Forenuhr geht immer noch falsch!</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f1r3">Meine Sprache steht auf diesem Board nicht zur Auswahl!</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f1r4">Wie kann ich ein Bild bei meinem Benutzernamen anzeigen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f1r5">Was ist mein Rang und wie kann ich ihn ändern?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f1r6">Wenn ich bei einem Benutzer auf den E-Mail-Link klicke, werde ich aufgefordert, mich anzumelden.</a></span><br />
			
			<br />
		
			<span class="gen"><b>Beiträge schreiben</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r0">Wie schreibe ich ein Thema?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r1">Wie kann ich einen Beitrag bearbeiten oder löschen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r2">Wie kann ich meinem Beitrag eine Signatur anfügen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r3">Wie kann ich eine Umfrage erstellen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r4">Wieso kann ich nicht mehr Antwortmöglichkeiten erstellen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r5">Wie bearbeite oder lösche ich eine Umfrage?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r6">Warum kann ich auf bestimmte Foren nicht zugreifen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r7">Weshalb kann ich keine Dateianhänge anfügen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r8">Weshalb wurde ich verwarnt?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r9">Wie kann ich Beiträge den Moderatoren melden?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r10">Was bewirkt die „Speichern“-Schaltfläche beim Schreiben eines Beitrags?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r11">Warum muss mein Beitrag erst freigegeben werden?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f2r12">Wie markiere ich ein Thema als neu?</a></span><br />
			
			<br />
		
			<span class="gen"><b>Textformatierung und Thementypen</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f3r0">Was ist BBCode?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f3r1">Kann ich HTML benutzen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f3r2">Was sind Smilies?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f3r3">Kann ich Bilder in meine Beiträge einfügen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f3r4">Was sind globale Bekanntmachungen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f3r5">Was sind Bekanntmachungen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f3r6">Was sind wichtige Themen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f3r7">Was sind geschlossene Themen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f3r8">Was sind Themen-Symbole?</a></span><br />
			
			<br />
		
			<span class="gen"><b>Benutzer-Stufen und Gruppen</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f4r0">Was sind Administratoren?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f4r1">Was sind Moderatoren?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f4r2">Was sind Benutzergruppen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f4r3">Wo finde ich die Benutzergruppen und wie trete ich ihnen bei?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f4r4">Wie werde ich Gruppenleiter?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f4r5">Weshalb werden verschiedene Benutzergruppen farbig dargestellt?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f4r6">Was ist eine Hauptgruppe?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f4r7">Was bedeutet der „Das Team“-Link auf der Startseite?</a></span><br />
			
			<br />
		
			<span class="gen"><b>Private Nachrichten</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f5r0">Ich kann keine Privaten Nachrichten verschicken!</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f5r1">Ich bekomme ständig unerwünschte Private Nachrichten!</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f5r2">Ich habe eine Spam-E-Mail von einem Mitglied dieses Forums erhalten!</a></span><br />
			
			<br />
		
			<span class="gen"><b>Freunde und ignorierte Mitglieder</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f6r0">Wozu benötige ich die Listen der Freunde und ignorierten Mitglieder?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f6r1">Wie kann ich Mitglieder zur Liste der Freunde oder zur Liste der ignorierten Mitglieder hinzufügen oder diese wieder aus den Listen entfernen?</a></span><br />
			
			<br />
		
			<span class="gen"><b>Die Foren durchsuchen</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f7r0">Wie kann ich ein Forum oder mehrere Foren durchsuchen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f7r1">Weshalb erhalte ich bei der Suche keine Ergebnisse?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f7r2">Warum bekomme ich bei der Suche eine leere Seite?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f7r3">Wie kann ich nach Mitgliedern suchen?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f7r4">Wie kann ich meine eigenen Beiträge und Themen finden?</a></span><br />
			
			<br />
		
			<span class="gen"><b>Benachrichtigungen und Lesezeichen</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f8r0">Was ist der Unterschied zwischen einem Lesezeichen und der Beobachtung eines Themas oder Forums?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f8r1">Wie kann ich ein Forum oder ein Thema beobachten?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f8r2">Wie deaktiviere ich meine Benachrichtigungen?</a></span><br />
			
			<br />
		
			<span class="gen"><b>Dateianhänge</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f9r0">Welche Dateianhänge sind in diesem Forum zulässig?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f9r1">Kann ich eine Übersicht all meiner Dateianhänge erhalten?</a></span><br />
			
			<br />
		
			<span class="gen"><b>phpBB3 betreffende Fragen</b></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f10r0">Wer hat diese Forensoftware entwickelt?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f10r1">Warum ist Funktion x oder y nicht enthalten?</a></span><br />
			
				<span class="gen"><a class="postlink" href="faq.php#f10r2">An wen soll ich mich wenden, falls es Beschwerden oder juristische Anfragen zu diesem Forum gibt?</a></span><br />
	...
	<br clear="all" />
		...
		<tr>
				...
				<div class="postbody">In der Beitragsansicht können zwei Bilder bei Ihrem Benutzernamen stehen. Eines dieser Bilder ist meist mit Ihrem Rang verknüpft: Oft sind dies Sterne, Kästchen oder Punkte, die Ihre Beitragszahl oder Ihren Status im Forum angeben. Das andere, meist größere Bild, wird auch als „Avatar“ bezeichnet. Es handelt sich hierbei in der Regel um ein persönliches Bild, welches von Benutzer zu Benutzer unterschiedlich ist. Die Board-Administration kann bestimmen, ob und wie die Benutzer Avatare benutzen können. Wenn Sie keinen Avatar benutzen dürfen, sollten Sie die Board-Administration nach den Gründen dafür fragen.</div>
				<p class="gensmall"><a href="#faqtop">Nach oben</a></p>
			</td>
		</tr>
		<tr>
...
<div align="right">
	...
	<tr>
		...
		<option value="-1">------------------</option>
			<option value="6">Klammsbrücker Herold</option>
		
			<option value="3">&nbsp; &nbsp;Tagebücher</option>
		
			<option value="21">&nbsp; &nbsp;&nbsp; &nbsp;1. G7 - Alptraum ohne Ende</option>
		
			<option value="22">&nbsp; &nbsp;&nbsp; &nbsp;2. G7 - Grenzenlose Macht</option>
		
			<option value="23">&nbsp; &nbsp;&nbsp; &nbsp;3. G7 - Unsterbliche Gier</option>
		
			<option value="24">&nbsp; &nbsp;&nbsp; &nbsp;4. G7 - Pforten des Grauens</option>
		
			<option value="25">&nbsp; &nbsp;&nbsp; &nbsp;5. G7 - Bastrabuns Bann</option>
		
			<option value="26">&nbsp; &nbsp;&nbsp; &nbsp;6. G7 - Schatten im Zwielicht</option>
		
			<option value="27">&nbsp; &nbsp;&nbsp; &nbsp;7. G7 - Goldene Blüten auf Blauem Grund</option>
		
			<option value="31">&nbsp; &nbsp;&nbsp; &nbsp;8. G7 - Winter des Wolfes</option>
		
			<option value="35">&nbsp; &nbsp;&nbsp; &nbsp;9. G7 - Rohals Versprechen</option>
		
			<option value="36">&nbsp; &nbsp;&nbsp; &nbsp;10. G7 - Siebenstreich</option>
		
			<option value="43">&nbsp; &nbsp;&nbsp; &nbsp;11. G7 - Rausch der Ewigkeit</option>
		
			<option value="9">&nbsp; &nbsp;Zwischenspiele</option>
		
			<option value="4">&nbsp; &nbsp;NPC's, Ereignisse und mehr</option>
		
			<option value="28">Die Phileassonsaga</option>
		
			<option value="29">&nbsp; &nbsp;Terminabsprachen</option>
		
			<option value="30">&nbsp; &nbsp;Tagebücher</option>
		
			<option value="40">Horasgruppe</option>
		
			<option value="41">&nbsp; &nbsp;Termine</option>
		
			<option value="42">&nbsp; &nbsp;Inneraventurisches</option>
